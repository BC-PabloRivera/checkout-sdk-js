...
export default class StripeUPEPaymentStrategy implements PaymentStrategy {
    ...
    async initialize(options: PaymentInitializeOptions): Promise<InternalCheckoutSelectors> {
        ...
        const { initializationData: { stripePublishableKey, stripeConnectedAccount, browserLanguageEnabled, shopperLanguage } } = paymentMethod;
        ...
        this._stripeElements = this._stripeElements ?? this._stripeUPEClient.elements({
            ...
            locale: browserLanguageEnabled ? 'auto' : formatLocale(shopperLanguage),
        });
